    ...
    if uploaded_file:
        ...
        if selected_pitcher == "All":
            ...
            for _, row in pitcher_df.iterrows():
                ...
                ax.plot(x, y, 'o', color='red' if row['IsFastball'] else 'blue')
            ax.add_patch(plt.Rectangle((ZONE_SIDE_LEFT, ZONE_BOTTOM), ZONE_SIDE_RIGHT - ZONE_SIDE_LEFT, ZONE_TOP - ZONE_BOTTOM, edgecolor='black', fill=False))
            ax.set_xlim(-10, 10)
            ax.set_ylim(18, 42)
